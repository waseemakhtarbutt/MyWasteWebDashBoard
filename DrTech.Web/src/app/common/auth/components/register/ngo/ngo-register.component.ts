...
@Component({
  selector: 'nb-ngo-register',
  styleUrls: ['./ngo-register.component.scss'],
  templateUrl: './ngo-register.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NbNGORegisterComponent implements OnInit{
  zoom: number = 8;
  ...
  async ngOnInit() {
    ...
    var response2 = await this.regService.getNgoDropdown();
  ...
  async register(){
    ...
    var response  = await this.userService.registerNgo(this.user, this.file);
