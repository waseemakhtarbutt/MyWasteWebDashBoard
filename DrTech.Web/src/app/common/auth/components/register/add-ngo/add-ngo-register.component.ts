...
@Component({
  selector: 'nb-add-ngo-register',
  styleUrls: ['./add-ngo-register.component.scss'],
  templateUrl: './add-ngo-register.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class NbAddNgoRegisterComponent {
  ...
  async Add() {
    ...
    const response = await this.regService.addNgo(this.model.fullName, this.file);
    if (response.data) {
