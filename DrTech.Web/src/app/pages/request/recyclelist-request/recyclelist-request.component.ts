...
@Component({
  selector: 'ngx-recyclelist-request',
  templateUrl: './recyclelist-request.component.html',
  styleUrls: ['./recyclelist-request.component.scss'],
  styles: [`
    nb-card {
...
export class RecyclelistRequestComponent implements OnInit {
